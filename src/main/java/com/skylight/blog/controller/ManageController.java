...
public class ManageController {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public boolean addArticle(String title,String author,String url,String imageUrl, String summary,Long categoryId,String content,String labels,int isOriginal){
    ...
    //imageUpload For ArticleInfoList
    @RequestMapping(value="/imageUpload",method=RequestMethod.POST)
    @ResponseBody
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public Map<String,Object> uploadImage(@RequestParam(value = "image", required = true) MultipartFile file, HttpServletRequest request, HttpServletResponse response)
    {
        Map<String,Object> resultMap = new HashMap<>();
        try {
            request.setCharacterEncoding("utf-8");
